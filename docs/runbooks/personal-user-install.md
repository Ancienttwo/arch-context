...
This runbook is the current individual-user install path for `archctx@0.4.6`.
...
- Required release artifact: public npm package `archctx@0.4.6` (`latest`).
