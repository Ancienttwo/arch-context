...
- `bun run verify`: passed; includes `tsc --noEmit`, the Bun test suite, route audit, metadata capture audit, capture manifest readback, security scan manifest readback, and sprint evidence-claim check.
