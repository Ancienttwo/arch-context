...
- Public release package: `archctx@0.1.0`.

## Approved Boundary

- Approves only the personal-user Beta launch for `archctx@0.1.0`.
- A personal user may install with `npm install -g archctx@0.1.0` after installing Bun.
