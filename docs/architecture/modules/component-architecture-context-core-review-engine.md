...
Gates task completion by validating the landscape, cross-repo pressure, and compatibility contracts behind a ChangeSet.
...
- `semantic-edge-missing`: component.architecture-context.core.review-engine has no declared in-scope relation
...
- `flow-missing`: no ArchitectureFlowV1 declares component.architecture-context.core.review-engine
<!-- END ARCHCONTEXT:generated target="projection_target.entity.component-architecture-context-core-review-engine" -->
