...
> **Detected**: 2026-08-18T16:41:09+0800
> **Updated**: 2026-08-18T16:41:09+0800
> **Severity**: medium
...
| --- | --- | --- | --- | --- |
| 2026-08-18T16:41:09+0800 | medium | boundary-or-config | `package.json` | `sha256:34e78abdd687424fc2fad5c2930fcb83295968f0a7047b9dc47d60d9bddb9c8d` |

## Event Fields

```json
{
  "ts": "2026-08-18T16:41:09+0800",
...
- Status: No architecture change
- Archived: 2026-08-18T20:26:59+0800
- Artifacts: (none)
- Note: package.json is byte-identical to HEAD (the 0.4.4 bump landed in 4060945); the event carried no boundary, entrypoint, dependency, runtime-path, or verification-command change to assess.
