...
| Real cloud control-plane and credential delivery | Local connection truthfulness is complete, while production cloud delivery is outside the local audit-repair scope | D1/Queue/OAuth/device registration and cross-process OS credentials remain unimplemented delivery gates; do not report a real connection or close the cloud gate | An explicitly approved cloud-delivery milestone; entrypoints: docs/adr/ADR-0017-cloudflare-control-plane.md and docs/adr/ADR-0016-signed-local-attestation.md |
