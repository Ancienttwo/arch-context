...
| Capability producer/consumer contract and formal acceptance (#225) | Installed harness rejects the existing model before acceptance freeze | #223 remains Draft without a typed receipt; no direct YAML or guard bypass | Agree ownership semantics, align initializer/consumer and use a complete ChangeSet migration if required |
