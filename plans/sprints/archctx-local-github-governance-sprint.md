...
|---|---|---:|---:|---:|
| FG0 | 契约修订与可信台账 | 18 | 5 | 0 / 23 |
| FG1 | 单一安装与本地 Surface | 18 | 6 | 0 / 24 |
...
|---:|:---:|---|---|---|---|
| 1 | [ ] | `archctx-fg0-contract-correction` | contract | 文案、ADR、Schema、状态机和信任等级一致 | `docs/verification/fg0-contract-correction-gate.md` |
...
| FG0-EG2 | ◻ | V2 Schema 有 valid/invalid/boundary fixtures | E1 | `bun test packages/contracts/test/github-governance-contracts.test.ts` |
