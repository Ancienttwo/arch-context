...
| 2026-06-20 | FG2 | GitHub App install disclosure complete | Control-plane GitHub App tab lists install action, current permissions, permission uses, retention, local Review privacy promise, and FG2-02 Commit Statuses pending disclosure | Codex |
| 2026-06-20 | FG2 | GitHub governance threat model updated | `docs/security/threat-model-v1.md` covers permission expansion, SDK/API drift, raw payload/log leakage, webhook replay, and remaining FG2-02/FG2-17 gates | Codex |
...
| 2026-06-20 | FG2 | Staging evidence packet established; gates remain blocked | `docs/verification/fg2-staging-evidence.json` and `scripts/fg2-staging-evidence-readback.mjs` bind FG2-02/17/EG1/EG4/EG5/EG6/EG7 to one strict readback; no gate was marked complete | Codex |
