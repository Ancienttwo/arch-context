...
| 3 | [x] | AXR2 [arch-context] dirty-worktree provenance and CodeGraph 1.5.0 snapshot handshake | contract | actual binary/version/sync/indexed-worktree digests are bound to receipt; stale/mismatch cases fail closed; source+docs same commit remains fresh | `plans/plan-20260808-1735-axr2-arch-context-dirty-worktree-provenance-and-codegraph-1-5-0-snapshot-handshake.md` |
...
| 2026-08-09 23:02 | AXR8 [both] npm release, selected-runtime readback, strict gate, and final capability authority cutover | `plans/archive/plan-20260809-0555-axr8-release-authority-cutover.md` | done at `arch-context@65500c0` and `repo-harness@e825118f`; all three public packages match accepted integrity, selected Bun-global runtime is `0.14.0`, package-local `archctx` is `0.4.0`, strict projection/freshness is clean, capability authority is 10/10, and the owner-authorized typed waiver closes review |
...
- AXR8 is complete: registry publication, exact dependency pins, selected Bun-global readback, strict gates, and the 10/10 authority cutover all passed. No Sprint backlog row remains.
