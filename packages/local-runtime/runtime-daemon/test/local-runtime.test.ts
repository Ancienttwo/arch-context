import { normalizeExistingPath, expectSameExistingPath, createGitRepo, createInitializedGitRepo, gitOut, rmSync, tempRepo, removeTempRepo, removeTempPath, sleep, readText, createStartedTestDaemon } from "./runtime-test-fixtures";
import { afterAll, describe, expect, spyOn, test } from "bun:test";
import { execFileSync, spawn, type ChildProcess } from "node:child_process";
import { verify } from "node:crypto";
import { once } from "node:events";
import { chmodSync, existsSync, lstatSync, mkdirSync, mkdtempSync, readdirSync, readFileSync, realpathSync, renameSync, rmSync as nodeRmSync, statSync, symlinkSync, writeFileSync } from "node:fs";
...
import { ARCHITECTURE_DOCS_RENDERER_VERSION, digestJson, INVESTIGATION_REPORT_SCHEMA_VERSION, type CodeFactsPort, type ExternalDocumentationPort, type Json, type JsonEnvelope, type ModelStorePort, type NormalizedCodeContext } from "@archcontext/contracts";
